// faça um programa que receba as idades de 10 pessoas e armazene em um vetor. mostre as idades em ordem crescente. use ordenação por seleção//
...
//criar-se um laço for, aqui ele ta dizendo que comça em 0 e vai ate 10
	...
	//aqui ele cria outro for para mostrar as idades e em ordem 
	 for(int x=0; x<10; x++){
	 	...
	 	printf("A Ordem crescente das idades informadas são: %d\n", idades[x]);
